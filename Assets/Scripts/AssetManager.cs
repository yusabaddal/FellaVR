...
public class AssetManager : MonoBehaviour
{
    ...
    {
        if(selfVariant.varyant_object!=null || selfVariant.varyant_model_object != "")
        {
            StartCoroutine(this._LoadBundle(selfVariant.varyant_object,true,selfVariant.varyant_name+"_Aski"));
        }
        if (selfVariant.varyant_model_object != null || selfVariant.varyant_model_object != "")
        {
            StartCoroutine(this._LoadBundle(selfVariant.varyant_model_object,false, selfVariant.varyant_name + "_Avatar"));
        }
    }
    void checkModels()
    {
